...
Versión: 2.3 - Corregido: todos los métodos retornan (bool, str). Eliminado retorno de ID innecesario.
"""
...
class InventarioController:
    ...
    - 👉 TODOS los métodos de escritura retornan (bool, str)
    """
    ...
    def agregar_disfraz(self, codigo_barras, descripcion, talla, color, categoria,
        ...
        if self.buscar_por_codigo(codigo_barras):
            ...
            return False, f"El código '{codigo_barras}' ya existe"
        ...
        try:
            ...
            return True, "Disfraz agregado exitosamente"
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("PRUEBA - InventarioController v2.3")
