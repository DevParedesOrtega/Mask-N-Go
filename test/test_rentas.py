...
def limpiar_datos_prueba():
    ...
    db.ejecutar_update("DELETE FROM DETALLE_RENTAS WHERE Id_Renta IN (SELECT Id_Renta FROM RENTAS WHERE Id_Cliente = %s)", (id_cliente_test,))
